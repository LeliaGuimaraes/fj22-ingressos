...
public class SessaoTest {
	...
	public void oPrecoDaSessaoDeveSerIgualASomaDoPrecoDaSalaMaisOPrecoDoFilme(){
			...
			Sala sala = new Sala("Eldourado - IMAX", new BigDecimal("22.5"));
	...
	public void garanteQueOLugarA1EstaOcupadoEOsLugaresA2EA3Disponiveis(){
		...
		Filme rougeOne = new Filme("Rouge One", Duration.ofMinutes(120), "SCI-FI", new BigDecimal("12.0"));
		Sala eldourado7 = new Sala("Eldourado 7",new BigDecimal("8.5"));
		Sessao sessao = new Sessao(LocalTime.now(), rougeOne, eldourado7);
